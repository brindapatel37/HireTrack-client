                ...
                <div className="jobs__cell">
                  ...
                  >
                    ...
                    editingField?.field === "company_name" ? (
                      <input
                        className="jobs__input jobs__input--company"
                        type="text"
                ...
                <div className="jobs__cell">
                  ...
                  >
                    ...
                    editingField?.field === "job_title" ? (
                      <input
                        className="jobs__input jobs__input--title"
                        type="text"
                ...
                <div className="jobs__cell">
                  ...
                  >
                    ...
                    editingField?.field === "job_location" ? (
                      <input
                        className="jobs__input jobs__input--location"
                        type="text"
                ...
                <div className="jobs__cell">
                  ...
                  >
                    ...
                    editingField?.field === "application_date" ? (
                      <input
                        className="jobs__input jobs__input--date"
                        type="date"
                ...
                <div className="jobs__cell">
                  ...
                  >
                    ...
                    editingField?.field === "job_status" ? (
                      <select
                        className="jobs__input jobs__input--job-status"
                ...
                <div className="jobs__cell">
                  ...
                  >
                    ...
                    editingField?.field === "salary" ? (
                      <input
                        type="number"
                        className="jobs__input jobs__input--salary"
                ...
                <div className="jobs__cell">
                  ...
                  >
                    ...
                    editingField?.field === "notes" ? (
                      <textarea
                        className="jobs__input jobs__input--notes"
